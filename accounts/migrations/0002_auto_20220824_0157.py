...
def populate_roles(apps,schemaeditor):
    roles = {
        "reader": "A person with a subcription to our newspaper",
        "journalist": "A person that writes journalistic content",
        "columnist": "A person that creates colums for the newspaper",
...
def populate_dept(apps,schemaeditor):
    depts = {
        ...
        "Business": "News related to businesses, stock prices, ect.",
    }        
